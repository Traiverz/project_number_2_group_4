...
class viz_info(tk.Toplevel):
    ...
    def v_info(self):
        ...
        btn_ent = tk.Button(self,text='Ввод', compound=tk.TOP, width=16, command=self.sh)
        btn_ent.place(x=260, y=10)
        btn_ent1 = tk.Button(self, text='Ввод(тест)', compound=tk.TOP, width=16, command=self.sh1)
        btn_ent1.place(x=400, y=10)
